...
fn default_one_month() -> TestResult {
    let cmd = command!().assert().success();
...
fn test_2_2020_leap_year() -> TestResult {
    run(&["-m", "2", "2020"], "tests/calr/expected/2-2020.txt")
}

// --------------------------------------------------
#[test]
fn test_4_2020() -> TestResult {
    run(&["-m", "4", "2020"], "tests/calr/expected/4-2020.txt")
}

// --------------------------------------------------
#[test]
fn test_april_2020() -> TestResult {
    run(&["2020", "-m", "april"], "tests/calr/expected/4-2020.txt")
}

// --------------------------------------------------
#[test]
fn test_2020() -> TestResult {
    run(&["2020"], "tests/calr/expected/2020.txt")
}

// --------------------------------------------------
#[test]
fn year() -> TestResult {
    let cmd = command!().arg("-y").assert().success();
